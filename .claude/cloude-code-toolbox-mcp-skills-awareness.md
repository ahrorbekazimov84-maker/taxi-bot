...
_Generated: 2026-06-03T11:06:40.260Z_
...
Workspace `mcp.json` _(folder: taxi-app)_

- **d:\taxi-app\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\ahror\.claude.json** — _File exists — no servers defined_
